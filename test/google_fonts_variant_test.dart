...
void main() {
  ...
  testWidgets('toApiFilenamePart() works for all normal combintaions', (tester) async {
    expect(
  ...
  testWidgets('toApiFilenamePart() works for all italic combintaions', (tester) async {
    expect(
      const GoogleFontsVariant(
        fontWeight: FontWeight.w100,
  ...
  testWidgets('fromApiFilenamePart() works for all normal combintaions', (tester) async {
    expect(
  ...
  testWidgets('fromApiFilenamePart() works for all italic combintaions', (tester) async {
    expect(
